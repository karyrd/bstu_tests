...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        [Test]
        public void DoesAirportHaveMilitaryPlanesTest()
        {
            ...
            {
                Assert.IsTrue(militaryPlane.PlaneTypeIs() == MilitaryType.TRANSPORT);
            }
        }

        [Test]
        public void DoesCurrentPlaneMAXLoadCapacityGreaterThenMAXLoadCapacityOfNextPlaneTest()
        {
